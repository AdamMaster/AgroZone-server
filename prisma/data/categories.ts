...
const CATEGORY_TREE = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        // Новая ветка уровня 2 (сестра "Семена, посевной материал"), а не
        // лист внутри неё — иначе видовые подкатегории саженцев (хвойные/
        // лиственные) оказались бы на 4-м уровне вложенности, а в проекте
        // жёсткое ограничение в 3 уровня (см. category-cascader.tsx — грид
        // захардкожен на 3 колонки). У "Саженцы" на уровне 2 есть место для
        // собственных листьев на уровне 3 без превышения лимита. Деление по
        // хвойные/лиственные деревья/лиственные кустарники — по образцу
        // реальных категорий Avito (подтверждено скринами флоу подачи
        // объявления) и agrobazar.ru.
        name: 'Саженцы',
        id: 'cat_03nuhy6',
        children: [
          {
